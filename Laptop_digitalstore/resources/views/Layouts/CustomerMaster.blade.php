...
<body class="main-layout">
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              <li class="nav-item">
                                 <a class="nav-link" href="{{route('customerhome')}}"> Home </a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="{{route('brandview')}}">Buy</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="{{route('myrequest')}}">My Request</a>
                              </li>
                           </ul>
                           <div class="sign_btn"><a href="{{route('logout')}}">Sign out</a></div>
                        </div>
                     </nav>
                  </div>
               </div>
      ...
      <div class="footer">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="cont">
                     <h3> <strong class="multi"> A laptop in your hands is the bridge between imagination and
                           reality.</strong>
         ...
         <div class="copyright">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <p>© 2024 All Rights Reserved. Design by <a href="">Alvin Antony</a>
                     </p>
                  </div>
               </div>
            </div>
   ...
   <script
      src="{{asset('Customer/https:cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.js')}}"></script>
</body>

   ...
   <div class="container-fluid">
      <div class="row d_flex">
         ...
         <div class="col-md-7 padding_right1">
            <div class="text-img">
               <figure><img src="{{asset('Guest/images/top_img.png')}}" alt="#" /></figure>
               <h3>01</h3>
            </div>
         </div>
      </div>
   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-md-8 offset-md-2 ">
            <div class="about_box ">
               <figure><img src="{{asset('Guest/images/about_img.png')}}" alt="#" /></figure>
      ...
      <div class="row d_flex">
         <div class="col-md-6">
            <div class="two_box_img">
               <figure><img src="{{asset('Guest/images/leptop.jpg')}}" alt="#" /></figure>
            </div>
         </div>
         <div class="col-md-6">
            <div class="two_box_img">
                        ...
                        <div class="carousel-caption ">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="test_box">
                                    <h3>Michl ro</h3>
                                    <p><i class="padd_rightt0"><img src="{{asset('Guest/images/te1.png')}}"
                                             alt="#" /></i>There are many variations of passages of Lorem Ipsum
                                       available, but the majority have suffered alteration in some <i
                                          class="padd_leftt0"><img src="{{asset('Guest/images/te2.png')}}"
                                             alt="#" /></i> <br>form, by injected humour, or randomised words which
